...
void SW_R_DrawAlphaSurfaces( void );
...
void SW_R_PushDlights (model_t *model);
...
void SW_R_LightPoint(vec3_t p, vec3_t color);
...
void	SW_LoadPCX(char *filename, byte **pic, byte **palette, int *width, int *height);
