...
void R_DrawSprite (void)
{
	...
	currententity->currframe %= s_psprite->numframes;

	s_psprframe = &s_psprite->frames[currententity->currframe];

	r_polydesc.pixels       = currentmodel->skins[currententity->currframe]->pixels[0];
