...
/*
================
SW_R_RecursiveWorldNode
================
*/
static void SW_R_RecursiveWorldNode(mnode_t *node, int clipflags)
{
	int c;
	...
	else
	{
		...
		SW_R_RecursiveWorldNode (node->children[side], clipflags);
...
void R_RenderWorld (void)
{
	...
	r_worldentity.currframe = (int)(r_newrefdef.time*2);
	...
	SW_R_RecursiveWorldNode (currentmodel->nodes, 15);
}
