...
/*
===============
SW_R_TextureAnimation

Returns the proper texture for a given time and base texture
===============
*/
image_t *SW_R_TextureAnimation (mtexinfo_t *tex)
{
	int c;
	...
	c = currententity->currframe % tex->numframes;
	while (c)
	{
		tex = tex->next;
		c--;
...
surfcache_t *D_CacheSurface (msurface_t *surface, int miplevel)
{
	...
	//
	r_drawsurf.image = SW_R_TextureAnimation(surface->texinfo);
